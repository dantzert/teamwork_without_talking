...
ax.semilogy(expected_report_frequency, scores.loc['hi-fi'], label='high fidelity', linestyle='dashed',color='blue', marker='o', linewidth=l_width, markersize = 3*l_width)
ax.semilogy(expected_report_frequency, scores.loc['lo-fi'], label='low fidelity', linestyle='dotted',color='red', marker='o', linewidth=l_width, markersize = 3*l_width)

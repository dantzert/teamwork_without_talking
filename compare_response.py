...
dropout_rate = '0.99_' # many options for this one, see tune_control.py
...
centralized_data = pd.read_pickle("C:/teamwork_without_talking/results/centralized_0.0_summer_2020.pkl")
...
if year == '2021':
    if duration == 'storm': # dates TBD for 2021
        ...
        end_date = datetime.datetime(2021, 6, 26, 0, 0)
    else:
...
for control_scenario in control_scenarios:
    ...
    axs[0,0].annotate("10 depth",xy=(0.1,0.75),xycoords = 'axes fraction', fontsize = 'x-large')
    axs[0,0].set_xticks([])
    ...
    axs[1,0].annotate("10 flow",xy=(0.1,0.75),xycoords = 'axes fraction', fontsize = 'x-large')
    axs[1,0].set_xticks([])
    ...
    axs[0,1].annotate("7 depth",xy=(0.1,0.75),xycoords = 'axes fraction', fontsize = 'x-large')
    axs[0,1].set_xticks([])
    ...
    axs[1,1].annotate("7 flow",xy=(0.1,0.75),xycoords = 'axes fraction', fontsize = 'x-large')
    axs[1,1].set_xticks([])
    ...
    axs[0,2].annotate("8 depth",xy=(0.1,0.75),xycoords = 'axes fraction', fontsize = 'x-large')
    axs[0,2].set_xticks([])
    ...
    axs[1,2].annotate("8 flow",xy=(0.1,0.75),xycoords = 'axes fraction', fontsize = 'x-large')
    axs[1,2].set_xticks([])
    ...
    axs[2,2].annotate("6 depth",xy=(0.1,0.75),xycoords = 'axes fraction', fontsize = 'x-large')
    axs[2,2].set_xticks([])
    ...
    axs[2,1].annotate("6 flow",xy=(0.1,0.75),xycoords = 'axes fraction', fontsize = 'x-large')
    axs[2,1].set_xticks([])
    #axs[2,1].set_yticks([])
    ...
    axs[2,0].annotate("4 depth",xy=(0.1,0.75),xycoords = 'axes fraction', fontsize = 'x-large')
    axs[2,0].set_xticks([])
    ...
    axs[3,0].annotate("4 flow",xy=(0.1,0.75),xycoords = 'axes fraction', fontsize = 'x-large')
    ...
    axs[3,1].annotate("1 depth",xy=(0.1,0.75),xycoords = 'axes fraction', fontsize = 'x-large')
    #axs[3,1].set_yticks([])
    ...
    axs[3,2].annotate("1 flow",xy=(0.1,0.75),xycoords = 'axes fraction', fontsize = 'x-large')
    #axs[3,2].set_yticks([])
